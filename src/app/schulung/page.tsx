...
export default function SchulungPage() {
  ...
  const topicContent: Record<string, { title: string; content: string[] }> = {
    "buy-crypto": {
      title: t("schulung.content.buyCrypto.title"),
      content: [
        t("schulung.content.buyCrypto.intro"),
        t("schulung.content.buyCrypto.step1"),
        t("schulung.content.buyCrypto.step2"),
        t("schulung.content.buyCrypto.step3"),
        t("schulung.content.buyCrypto.step4"),
        t("schulung.content.buyCrypto.conclusion"),
      ],
    },
    "create-wallet": {
      title: t("schulung.content.createWallet.title"),
      content: [
        t("schulung.content.createWallet.intro"),
        t("schulung.content.createWallet.types"),
        t("schulung.content.createWallet.step1"),
        t("schulung.content.createWallet.step2"),
        t("schulung.content.createWallet.step3"),
        t("schulung.content.createWallet.conclusion"),
      ],
    },
    "secure-wallet": {
      title: t("schulung.content.secureWallet.title"),
      content: [
        t("schulung.content.secureWallet.intro"),
        t("schulung.content.secureWallet.tip1"),
        t("schulung.content.secureWallet.tip2"),
        t("schulung.content.secureWallet.tip3"),
        t("schulung.content.secureWallet.tip4"),
        t("schulung.content.secureWallet.conclusion"),
      ],
    },
    "blockchain-basics": {
      title: t("schulung.content.blockchainBasics.title"),
      content: [
        t("schulung.content.blockchainBasics.intro"),
        t("schulung.content.blockchainBasics.concept1"),
        t("schulung.content.blockchainBasics.concept2"),
        t("schulung.content.blockchainBasics.concept3"),
        t("schulung.content.blockchainBasics.conclusion"),
      ],
    },
    "trading-basics": {
      title: t("schulung.content.tradingBasics.title"),
      content: [
        t("schulung.content.tradingBasics.intro"),
        t("schulung.content.tradingBasics.concept1"),
        t("schulung.content.tradingBasics.concept2"),
        t("schulung.content.tradingBasics.concept3"),
        t("schulung.content.tradingBasics.conclusion"),
      ],
    },
    "defi": {
      title: t("schulung.content.defi.title"),
      content: [
        t("schulung.content.defi.intro"),
        t("schulung.content.defi.concept1"),
        t("schulung.content.defi.concept2"),
        t("schulung.content.defi.concept3"),
        t("schulung.content.defi.conclusion"),
      ],
    },
  };
