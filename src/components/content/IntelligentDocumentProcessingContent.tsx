    ...
    <div id="canvas" style={{ padding: "2rem 0" }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          {[
            { icon: '🔌', label: t('idp_impl_1') },
            { icon: '🤖', label: t('idp_impl_2') },
            { icon: '🗄️', label: t('idp_impl_3') }
          ].map((item, idx) => (
            <div key={idx} style={{
              background: '#f8f9fa',
              padding: '1.25rem',
      ...
      <div style={{
        ...
        <div style={{
          ...
          {[
            { metric: '70%', label: t('idp_benefit_reduction'), icon: '⚡' },
            { metric: '95%', label: t('idp_benefit_accuracy'), icon: '🎯' },
            { metric: '24/7', label: t('idp_benefit_availability'), icon: '🌍' },
            { metric: '100%', label: t('idp_benefit_integration'), icon: '🔗' }
          ].map((item, idx) => (
            <div key={idx} style={{
              background: '#f8f9fa',
      ...
      <div style={{
        ...
        <div style={{
          ...
          >
            🗓️ {t('idp_cta_button_consultation')}
          </button>
          <button
            onClick={() => window.location.href = '/contact'}
            style={{
